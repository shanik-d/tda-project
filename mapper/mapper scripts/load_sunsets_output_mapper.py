...
for q in range(13):
    '''
        Step 1: Input
    '''
    filename = 'C:\Users\Shanik\Documents\uni\Computer Science\Year 3\project\Untitled Folder\sunset_vectors\sunset_data_' + str(q+1) + '.npy'
    savepath = '../mapper outputs/sunset_' + str(q+1) +'_output.png'
