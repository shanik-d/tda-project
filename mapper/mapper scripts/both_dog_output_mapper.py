...
for a in range(2):
    for q in range(13):
        ...
        if(a == 1):
            alg = 'SURF'
        filename = 'C:/Users/Shanik/Documents/uni/Computer Science/Year 3/project/python/numpy vectors/dog_vectors/dog_' + alg + '_' + str(q+1) + '.npy'
        savepath = '../mapper outputs/dog/' + alg + '/euc, ecc 2, uni 15 50, big 0 10/dog_' + alg + '_output_' + str(q+1) +'.png'
        scalesave = '../mapper outputs/dog/' + alg + '/euc, ecc 2, uni 15 50, big 0 10/dog_' + alg + '_scale_graph_' + str(q+1) +'.png'
